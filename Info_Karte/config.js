...
const Config = {
    wfsImgPath: "../Info_Karte/resources/img/",
    namedProjections: [[
    ...
    layerConf: "../Info_Karte/resources/services-internet.json",
    restConf: "../Info_Karte/resources/rest-services-internet.json",
    styleConf: "../Info_Karte/resources/style_v3.json",
    scaleLine: true,
    mouseHover: {
        numFeaturesToShow: 5,
