...
const Config = {
    wfsImgPath: "../Mitte/resources/img/",
    namedProjections: [[
    ...
    layerConf: "../Mitte/resources/services-internet.json",
    restConf: "../Mitte/resources/rest-services-internet.json",
    styleConf: "../Mitte/resources/style_v3.json",
    scaleLine: true,
    mouseHover: {
        numFeaturesToShow: 2,
